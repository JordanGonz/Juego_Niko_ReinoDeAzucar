...
export function classifyPlatform(
  ...
  if (y >= 450) return "ground";
  if (width <= 145) return "isolated";
  if (width < 220) return "short";
  return height > 55 ? "long" : "elevated";
}
