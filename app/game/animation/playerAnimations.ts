...
export const PLAYER_ANIMATION_CLIPS: Record<PlayerState, AnimationClip> = {
  ...
  jumpUp: { frames: [12, 13], frameDuration: 0.1, loop: true },
  fall: { frames: [14, 15], frameDuration: 0.12, loop: true },
  land: { frames: [16, 17, 18], frameDuration: 0.04, loop: false, events: [{ frame: 1, name: "land" }] },
  skid: { frames: [19, 20], frameDuration: 0.06, loop: true },
  hurt: { frames: [21, 22], frameDuration: 0.08, loop: true },
  death: { frames: [23, 24, 25, 26], frameDuration: 0.12, loop: false },
  victory: { frames: [27, 28, 29, 30], frameDuration: 0.12, loop: true },
};
